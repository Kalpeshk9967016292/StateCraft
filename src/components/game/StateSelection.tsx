...
import { Users, Landmark, GraduationCap, Gavel } from 'lucide-react';
...
export default function StateSelection({ states, onStateSelect }: StateSelectionProps) {
  return (
    <div className="flex flex-col items-center animate-fade-in">
      ...
      <p className="text-lg text-muted-foreground mb-8 text-center">Choose your state to begin your political journey.</p>
